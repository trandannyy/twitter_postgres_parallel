...
|     | sequential | parallel |
| --- | ---------- | -------- |
| normalized (unbatched) | ![](https://github.com/trandannyy/twitter_postgres_parallel/workflows/tests_normalized_sequential/badge.svg) | ![](https://github.com/trandannyy/twitter_postgres_parallel/workflows/tests_normalized_parallel/badge.svg) |
| normalized (batched) | ![](https://github.com/trandannyy/twitter_postgres_parallel/workflows/tests_normalizedbatch_sequential/badge.svg) |  ![](https://github.com/trandannyy/twitter_postgres_parallel/workflows/tests_normalizedbatch_parallel/badge.svg) |
| denormalized | ![](https://github.com/trandannyy/twitter_postgres_parallel/workflows/tests_denormalized_sequential/badge.svg) | ![](https://github.com/trandannyy/twitter_postgres_parallel/workflows/tests_denormalized_parallel/badge.svg) |
...
| -----------------------| ------------------------- | ------------------------- |
| `pg_normalized`        | "9m44.842s"               | "1m15.956s"               | 
| `pg_normalized_batch`  | "3m9.584s"                | "0m18.783s"               | 
| `pg_denormalized`      | "25.333s"                 | "3.3156s"                 | 
